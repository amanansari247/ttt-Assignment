...
export const Navbar = () => {
  ...
  return (
    <div>
      <div className='w-full bg-black  h-30 sm:h-2 flex  sm:flex-row items-center justify-between p-2 sm:p-14'>
        <div className='flex'>
          <img src={logo} className=' w-12 h-12 m-auto  sm:w-20 sm:h-20 hover:cursor-pointer' alt='logo' onClick={homescreen} />
          <div className=" w-6 h-18 sm:w-10 sm:h-20 border-l border-yellow-700 ml-4"></div>
        ...
        <div className='btn mt-2 sm:mt-0'>
